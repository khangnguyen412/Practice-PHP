    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 ">
                <div class="main-menu">
                    <ul>
                        <li><a href="<?php echo $url ?>view/userview/index.php">Trang Chủ</a></li>
                        ...
                        <li>
                            <?php
                                ...
                                if (isset($_SESSION["islogin"])) {
                                    ...
                                    echo '<a href="'.$urlDashboard.'dashboardview/signin.php">Đăng Nhập</a>';
                                }
                            ?>
                        </li>
    ...
    <div class="menu-text hide-on-pc">
        <nav class="navbar">
            <div class="collapse navbar-collapse" id="collapseExample">
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="<?php echo $url ?>view/userview/index.php">Trang Chủ</a></li>
