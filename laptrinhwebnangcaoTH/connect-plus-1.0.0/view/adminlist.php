                  ...
                  <tbody>
                    <?php                                          
                      foreach ($adminlist as $admin) {
                          ...
                          echo'    <td><a href="../controller/controller.php?action=edit&id=' . $admin['id_nameAtribute'] . '"   class="btn btn-light btn-fw btn-rounded">Edit</a></td>';
                          echo'    <td><a href="../controller/controller.php?action=delete&id=' . $admin['id_nameAtribute'] . '"   class="btn btn-danger btn-fw btn-rounded">Delete</a></td>';
                          echo'</tr>';
                      }
                    ?>       
                  </tbody>
