                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="text" name="id" disabled="" value="" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="text" name="username" required="" value="Mark" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="email" name="email" value="lamnhungoc@gmail.com" placeholder="E-mail" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-block btn-primary" name="create" style="width: 100px" type="submit">Create</button>
                                        </div>
                                    </div>
