...
insert into users (username, email, pass, sex, avt, address) values ("Khangnguyen", "khang@gmail.com", "khang", "nam", "../assets/img/products/product-img-1.jpg", "Lạc Long Quân");
...
drop table admins;
insert into admins (adminname, email, pass, sex, avt, address) values ("Khang", "khang@gmail.com", "khang", "nam", "../assets/img/products/product-img-1.jpg", "Lạc Long Quân");
select * from admins;
delete from admins;
drop table admins;