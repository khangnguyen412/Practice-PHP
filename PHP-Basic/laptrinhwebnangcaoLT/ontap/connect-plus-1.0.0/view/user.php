            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Khang</p>
                </div>
              </a>
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./user.php">
                ...
                <span class="menu-title">DS người dùng</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper"> 
            <button type="button" class="btn btn-success btn-rounded" style="margin-bottom: 20px;">Thêm người dùng</button>
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><label class="badge badge-success">Đang Sử Dụng</label></td>
                      <td>
                        <button type="button" class="btn btn-success btn-rounded">Sửa đổi</button>
          ...
          <footer class="footer">
            <div class="footer-inner-wraper">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Tài Liệu Ôn Tập</span>
