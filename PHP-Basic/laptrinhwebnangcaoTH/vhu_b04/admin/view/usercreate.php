                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="gioitinh" checked="" class="custom-control-input" value="male"><span class="custom-control-label">Male</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="gioitinh" class="custom-control-input" value="female"><span class="custom-control-label">Female</span>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" name="sothich[]" value="football"  class="custom-control-input"><span class="custom-control-label">Football</span>
                                            </label>
                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" name="sothich[]" value="walking"  class="custom-control-input"><span class="custom-control-label">Walking</span>
                                            </label>
                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" name="sothich[]" value="gaming" checked="" class="custom-control-input"><span class="custom-control-label">Gaming</span>
                                            </label>
                                        </div>
