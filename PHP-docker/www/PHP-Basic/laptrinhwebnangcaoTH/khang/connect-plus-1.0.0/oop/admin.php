<?php
    class admins{
        ...
        public function insertDB($param){
            $sql ="insert into admins (adminname, email, pass, sex, avt, address) values (:adminname, :email, :passwords, :sex, :avt, :address)";
            $condb = new connectdb();
            $condb->connect();
        ...
        public function updateDB($param){
            $sql ="update admins set adminname= :adminname, email = :email, pass = :passwords, sex = :sex, avt = :avt, address = :address where id_nameAtribute = :id";
            $condb = new connectdb();
            $condb->connect();
        ...
        public function getAdminnameDB($param){
            $sql ="select * from admins where adminname like :adminname";
            $userlist = array();
            $condb = new connectdb();
            $condb->connect();
            $userlist = $condb->getData($sql, $param);
        ...
        public function isAdmin($uname, $pass) {
            ...
            $avt = "";
            $arrUsers = array();
            $sql = "SELECT adminname, pass, avt FROM admins where adminname = :adminname";
            $arr_param = array("adminname" => $uname);
