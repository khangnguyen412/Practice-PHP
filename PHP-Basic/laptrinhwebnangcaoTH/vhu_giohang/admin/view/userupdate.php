                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <a href="../controller/usercontroller.php"   class="btn btn-outline-primary">Back</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="text" name="id" readonly value="<?php echo $userInfo[0]['id']; ?>" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="text" name="username" required="" value="<?php echo $userInfo[0]['username']; ?>" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" type="email" name="email" value="<?php echo $userInfo[0]['email']; ?>" placeholder="E-mail" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="custom-control custom-file custom-control-inline">
                                                <input type="file" name="avatar" value="football" >
                                            </label>

                                        </div>

                                        <div class="form-group">
                                            <button class="btn btn-block btn-primary" name="useraction" value="update" style="width: 100px" type="submit">Update</button>
                                        </div>
                                    </div>
