...
<head>
    ...
    <?php
    $url = '../';
    include '../view/userview/lib/header.php'
    ?>
</head>
...
<body>
    ...
    <!-- Header Area Starts -->
    <?php
    include '../view/userview/lib/navbar.php'
    ?>
    <!-- Header Area End -->
    ...
    <section class="food-area section-padding">
        ...
        <div class="container">
            ...
            if (isset($_SESSION["islogin"])) {
                ...
                echo '  <form action="../controller/controller.php?action=commentFood" method="post">';
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-top2 text-center">
                        ...
                        <a href="../view/userview/index.php" class="genric-btn primary circle m-2 justify-content-center" style="color: #000;">
    ...
    <!-- Footer Area Starts -->
    <?php
    include '../view/userview/lib/footer.php'
    ?>
    <!-- Footer Area End -->
    ...
    <!-- Javascript -->
    <?php
    include '../view/userview/lib/js.php'
    ?>
</body>
